...
import { createCourse, resetCreateCourseSuccess } from '../../store/slices/Courses/coursesSlice';
import { FaArrowLeft, FaPlus, FaMinus, FaUpload, FaInfoCircle } from 'react-icons/fa';

const AddCourse = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { createCourseLoading, createCourseError, createCourseSuccess } = useSelector((state) => state.courses);
  ...
  useEffect(() => {
    if (createCourseSuccess) {
      ...
      dispatch(resetCreateCourseSuccess());
      navigate('/all-courses');
    }
  }, [createCourseSuccess, dispatch, navigate]);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-slate-800/50 to-purple-800/50 backdrop-blur-lg border border-white/10 rounded-2xl p-6 mb-8 shadow-2xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-2">Fill in the details to create a new course</p>
            </div>
          </div>
        </div>
        ...
        {createCourseError && (
          <div className="bg-red-900/30 border border-red-400 text-red-200 px-4 py-3 rounded-lg backdrop-blur-sm mb-6" role="alert">
            ...
            <span className="block sm:inline"> {createCourseError}</span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="bg-gradient-to-r from-slate-800/50 to-purple-800/50 backdrop-blur-lg border border-white/10 rounded-2xl p-6 shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 mt-6">
              <div className="flex justify-between items-center mb-4 border-b border-purple-500/30 pb-2">
                <h2 className="text-2xl font-semibold text-white">Course Features</h2>
                <button 
                  type="button" 
                  onClick={addFeature}
                  className="bg-purple-600/50 text-white px-4 py-2 rounded-lg hover:bg-purple-700/50 transition-all duration-300 flex items-center"
                >
                ...
                <div key={index} className="flex items-center gap-4 mb-4">
                  ...
                  <div className="self-end mb-2">
                    <button 
                      ...
                      className="bg-red-600/50 text-white p-3 rounded-lg hover:bg-red-700/50 transition-all duration-300"
            ...
            <div className="md:col-span-2 mt-6">
              ...
              {formData.courseContent.map((section, sectionIndex) => (
                <div key={sectionIndex} className="bg-slate-700/30 border border-white/10 rounded-lg p-4 mb-4">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-semibold text-white">Section {sectionIndex + 1}</h3>
                    <button 
                      type="button" 
                      onClick={() => removeContentSection(sectionIndex)}
                      className="bg-red-600/50 text-white p-2 rounded-lg hover:bg-red-700/50 transition-all duration-300"
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between items-center mb-2">
                      <label className="text-gray-300">Lessons</label>
                      <button 
                        type="button" 
                        onClick={() => addLesson(sectionIndex)}
                        className="bg-green-600/50 text-white px-3 py-1 rounded-lg hover:bg-green-700/50 transition-all duration-300 flex items-center text-sm"
                      >
                    ...
                    {section.lessons.map((lesson, lessonIndex) => (
                      <div key={lessonIndex} className="bg-slate-600/30 border border-white/10 rounded-lg p-3 mb-3">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm text-gray-300">Lesson {lessonIndex + 1}</span>
                          <button 
                            type="button" 
                            onClick={() => removeLesson(sectionIndex, lessonIndex)}
                            className="bg-red-600/50 text-white p-1 rounded text-xs hover:bg-red-700/50 transition-all duration-300"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-2">
                          <input
                            ...
                            className="w-full bg-slate-800/50 border border-white/10 rounded-lg px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
                        ...
                        <div className="flex items-center">
                          ...
                          />
                          <label className="text-gray-300 text-sm">Preview available</label>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="md:col-span-2 mt-6">
              <div className="flex justify-between items-center mb-4 border-b border-purple-500/30 pb-2">
                ...
                <button 
                  ...
                  className="bg-purple-600/50 text-white px-4 py-2 rounded-lg hover:bg-purple-700/50 transition-all duration-300 flex items-center"
                >
                  <FaPlus className="mr-2" /> Add Audience
                </button>
              </div>
          ...
          <div className="mt-8 flex justify-end">
            <button
              ...
              className="bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-500 text-white px-8 py-4 rounded-full hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 flex items-center transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {createCourseLoading ? (
                <>
